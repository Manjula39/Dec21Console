...
namespace Dec21Console
{
    public class ABC
    {
        public ABC() { Console.WriteLine("abc 1 constructor "); }
        // ~ABC1(){ Console.WriteLine("destcructor of abc1"); }
    }
    public class ABC2 : ABC { public ABC2() { Console.WriteLine("ABC 2 Constructor "); } ~ABC2() { Console.WriteLine("ABC2 Destructor"); } }
